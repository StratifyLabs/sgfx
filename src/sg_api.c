...
const sg_api_t m_sg_api = {
		...
		.cursor_invert_hline  = sg_cursor_invert_hline,
		.cursor_clear_hline  = sg_cursor_clear_hline,
		...
		.invert_rectangle  = sg_invert_rectangle,
		.clear_rectangle  = sg_clear_rectangle,
